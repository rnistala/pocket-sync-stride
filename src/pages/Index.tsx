...
import { Search, X, Star, HelpCircle, Lightbulb } from "lucide-react";
  ...
  const tourSteps = [
    {
      ...
      title: "Welcome to Opterix 360! 👋",
      description: "Your AI-powered lead management solution. Let's take a quick tour of the key features.",
      position: "bottom" as const,
    },
    {
      target: '[data-tour="network-status"]',
      title: "Works Offline 📶",
      description: "Stay productive even without network coverage. Your changes sync automatically when you're back online.",
      position: "bottom" as const,
    },
    {
      target: '[data-tour="follow-up-calendar"]',
      title: "Follow-up Calendar 📅",
      description: "Your secret weapon to clear follow-up backlogs. See who needs attention today, this week, or any day you choose.",
      position: "bottom" as const,
    },
    {
      target: '[data-tour="contact-count"]',
      title: "Your Contacts 👥",
      description: "Manage 10s of thousands of contacts with ease. Search, filter, and find anyone in seconds.",
      position: "bottom" as const,
    },
    {
      target: '[data-tour="starred"]',
      title: "Starred Contacts ⭐",
      description: "Star your high-priority contacts for quick access and more intense follow-up attention.",
      position: "bottom" as const,
    },
    {
      target: '[data-tour="metrics"]',
      title: "Quick Stats 📊",
      description: "Three things you can do with Opterix 360: Follow-up with contacts, book orders, and manage action items (tickets).",
      position: "bottom" as const,
    },
    {
    ...
    },
    {
      ...
      description: "That's the quick tour! Start by tapping on any contact to begin your follow-ups. Happy selling!",
      position: "bottom" as const,
    },
  ];
